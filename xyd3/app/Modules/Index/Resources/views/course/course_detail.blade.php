                ...
                <div class="wp">
                    ...
                    <div class="personal">
                        ...
                        <div class="userdetail">
                            <dl>
                                <dt><img width="80" height="80" src="{{asset('inde/media/image/2016/12/default_big_14.pngx')}}"/></dt>
                                <dd>
                                    <h2>django</h2>
                                    <p>bobby</p>
                                </dd>
        ...
        <div class="groupPurchase_detail detail">
            <div class="toppro">
                <div class="left">
                    <div class="picbox">
                        <div class="tb-booth tb-pic">
                            <img width="440" height="445" src="{{asset('index/media/courses/2016/11/540e57300001d6d906000338-240-135_n0L8vbw.jpg')}}" class="jqzoom" />
                        </div>
                    ...
                    <div class="des">
                        ...
                        <ul class="parameter">
                            ...
                            <li class="piclist"><span class="pram word4">学习用户：</span>
                                ...
                                <span class="pic"><img width="40" height="40" src="{{asset('index/media/image/2016/12/default_big_14.png')}}"/></span>
                ...
                <div class="right">
                    ...
                    <div class="pic">
                        <a href="/company/14/">
                            <img width="150" height="80" src="{{asset('index/media/org/2016/11/bjdx.jpg')}}"/>
                        </a>
                    </div>
                    <a href="/company/14/">
                    ...
                    <div class="clear">
                        <ul>
                            ...
                            <li>认&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;证&nbsp;:
                                &nbsp;&nbsp;
                                <img title="金牌机构", src="{{asset('index/images/gold.png')}}"/>
                            </li>
                        </ul>
                    </div>
                </div>
                    ...
                    <dl>
                        <dt>
                            <a target="_blank" href="">
                                <img width="240" height="220" class="scrollLoading" src="{{asset('index/media/courses/2016/11/540e57300001d6d906000338-240-135_mvvGYHL.jpg')}}"/>
                            </a>
                        </dt>
                        <dd>
