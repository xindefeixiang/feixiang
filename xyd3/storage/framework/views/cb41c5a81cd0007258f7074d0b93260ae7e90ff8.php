...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo e(asset('index/css/muke/base.css')); ?>" />
    <link rel="stylesheet" type="text/css" href="<?php echo e(asset('index/css/muke/common-less.css')); ?>" />
    <link rel="stylesheet" type="text/css" href="<?php echo e(asset('index/css/muke/course/learn-less.css')); ?>" />
    <link rel="stylesheet" type="text/css" href="<?php echo e(asset('index/css/aui.css')); ?>" />
    <link rel="stylesheet" type="text/css" href="<?php echo e(asset('index/css/mooc.css')); ?>" />
    <link rel="stylesheet" type="text/css" href="<?php echo e(asset('index/css/muke/course/common-less.css')); ?>">
                        ...
                        <div class="box mb40">
                            ...
                            <ul class="downlist">
                                ...
                                <li>
                                    ...
                                    <a href="<?php echo e(asset('index/media/course/resource/2016/11/media.zip')); ?>" class="downcode" target="_blank" download="" data-id="274" title="">下载</a>
                                </li>
                        ...
                        <div class="box mb40">
                            ...
                            <div class="teacher-info">
                                <a href="/u/315464/courses?sort=publish" target="_blank">
                                    <img src='<?php echo e(asset('index/media/teacher/2016/11/aobama_CXWwMef.png')); ?>' width='80' height='80' />
                                </a>
                                <span class="tit">
                                    ...
                                    <ul class="other-list">
                                        ...
                                        <li class="curr">
                                            <a href="course_detail" target="_blank">
                                                <img src="<?php echo e(asset('index/media/courses/2016/11/540e57300001d6d906000338-240-135_n0L8vbw.jpg')); ?>" alt="django与vuejs实战项目2">
                                        ...
                                        <li class="curr">
                                            <a href="course_detail" target="_blank">
                                                <img src="<?php echo e(asset('index/media/courses/2016/12/python面向对象.jpg')); ?>" alt="python面向对象">
                                        ...
                                        <li class="curr">
                                            <a href="course_detail" target="_blank">
                                                <img src="<?php echo e(asset('index/media/courses/2016/12/python文件处理.jpg')); ?>" alt="python文件处理">
                                        ...
                                        <li class="curr">
                                            <a href="course_detail" target="_blank">
                                                <img src="<?php echo e(asset('index/media/courses/2016/11/mysql.jpg')); ?>" alt="django入门">
                                        ...
                                        <li class="curr">
                                            <a href="course_detail" target="_blank">
                                                <img src="<?php echo e(asset('index/media/courses/2016/12/mysql.jpg')); ?>" alt="xadmin进阶开发">
