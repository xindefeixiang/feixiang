...
<head>
    ...
    <link href="<?php echo e(asset('admin/css/login.css')); ?>" rel="stylesheet" rev="stylesheet" type="text/css" media="all" />
    <script type="text/javascript" src="<?php echo e(asset('admin/js/jQuery1.7.js')); ?>"></script>
    <script type="text/javascript" src="<?php echo e(asset('admin/jquery-1.8.2.min.js')); ?>"></script>
    <script type="text/javascript" src="<?php echo e(asset('admin/js/jquery1.42.min.js')); ?>"></script>
    <script type="text/javascript" src="<?php echo e(asset('admin/js/jquery.SuperSlide.js')); ?>"></script>
    <script type="text/javascript" src="<?php echo e(asset('admin/js/Validform_v5.3.2_min.js')); ?>"></script>
...
<div id="tab">
    ...
    <?php endif; ?>
        ...
        <div>
            ...
            <form action="admin/login" method="post" class="stu_login_error">
                <?php echo e(csrf_field()); ?>

                <div id="username">
                    <label>学&nbsp;&nbsp;&nbsp;号：</label>
                    <input type="text" id="stu_username_hide" name="email" value="输入学号" nullmsg="学号不能为空！" datatype="s6-18" errormsg="学号范围在6~18个字符之间！" sucmsg="学号验证通过！"/>
                ...
                <div id="code">
                    ...
                    <img src="<?php echo e(captcha_src()); ?>" onclick="this.src='<?php echo e(captcha_src()); ?>'+Math.random()" title="点击更换" alt="验证码占位图">
                     </div>
                <div id="remember">
        ...
        <div class="hide">
            ...
            <form action="" method="post" class="tea_login_error">
                ...
                <div id="code">
                    ...
                    <img src="<?php echo e(asset('admin/images//captcha.jpg')); ?>" title="点击更换" alt="验证码占位图"/> </div>
                <div id="remember">
                    <input type="checkbox" name="remember">
                    <label>记住密码</label>
                </div>
...
<div class="screenbg">
    <ul>
        <li><a href="javascript:;"><img src="<?php echo e(asset('admin/images//0.jpg')); ?>"></a></li>
        <li><a href="javascript:;"><img src="<?php echo e(asset('admin/images//1.jpg')); ?>"></a></li>
        <li><a href="javascript:;"><img src="<?php echo e(asset('admin/images//2.jpg')); ?>"></a></li>
    </ul>
</div>
</body>
</html>
