...
<div class="mainBox" style="height:auto!important;height:550px;min-height:550px;">
    <h3><a href="sclassshow" class="actionBtn">课程列表</a>添加课程</h3>
    <form action="sclassin" method="post" enctype="multipart/form-data">
        <table width="100%" border="0" cellpadding="8" cellspacing="0" class="tableBasic">
            ...
            <tr>
                ...
                <td>
                    <input type="text" name="intro" value="" size="80" class="inpMain" />
                </td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td>
                    <input type="text" name="num" value="" size="80" class="inpMain" />
                </td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td>
                    <textarea name="details" cols="25" rows="10"></textarea>
                </td>
            </tr>
            <tr>
                <td></td>
