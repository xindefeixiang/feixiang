...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{{asset('index/css/muke/course/course-comment.css')}}" />
                ...
                <div class="content">
                    <div class="mod-tab-menu">
                        <ul class="course-menu clearfix">
                            <li><a class="ui-tabs-active " id="learnOn"  href="course_video"><span>章节</span></a></li>
                            <li><a id="commentOn" class="active" href="course_comment"><span>评论</span></a></li>
                        </ul>
                    </div>
                    ...
                    <div id="course_note">
                        <ul class="mod-post" id="comment-list">
                            ...
                            <li class="post-row">
                                <div class="media">
                                    <span target="_blank"><img src="{{asset('index/media/image/2016/12/default_big_14.png')}}" width='40' height='40' /></span>
                                </div>
                                <div class="bd">
                                    <div class="tit">
                            ...
                            <li class="post-row">
                                <div class="media">
                                    <span target="_blank"><img src='{{asset('indexmedia/image/2016/12/default_big_14.png')}}' width='40' height='40' /></span>
                                </div>
                                <div class="bd">
                                    <div class="tit">
                                        <span target="_blank">bobby</span>
