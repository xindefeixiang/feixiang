            ...
            <div class="personal_des permessage">
                <div class="head">
                    <ul class="tab_header messagehead">
                        <li class="active"><a href="usercenter_fav_course">课程机构</a> </li>
                ...
                <div class="messagelist">
                        ...
                        <dl class="des fr">
                            <dt>
                                <a href="org_detail_homepage">
                                    <img width="160" height="90" src="{{asset('index/media/org/2016/11/imooc.png')}}"/>
                                </a>
                            </dt>
                            <dd>
                                <h1><a href="org_detail_homepage">慕课网</a></h1>
                    ...
                    <div class="messages butler_list company company-fav-box">
                        <dl class="des fr">
                            <dt>
                                <a href="org_detail_homepage">
                                    <img width="160" height="90" src="{{asset('index/media/org/2016/11/bjdx.jpg')}}"/>
                                </a>
                            </dt>
                            <dd>
                                <h1><a href="org_detail_homepage">北京大学</a></h1>
                                <div class="pic fl" style="width:auto;">
