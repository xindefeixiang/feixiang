            ...
            <div class="personal_des permessage">
                <div class="head">
                    <ul class="tab_header messagehead">
                        ...
                        <li><a href="usercenter_fav_teacher">授课教师 </a></li>
                        <li class="active"><a href="usercenter_fav_course">公开课程</a></li>
                    </ul>
                    ...
                    <div class="group_list brief">
                        ...
                        <div class="module1_5 box">
                            <a href="course_detail">
                                <img width="214" height="190" src="{{asset('index/media/courses/2016/12/57035ff200014b8a06000338-240-135_dHfj8Nq.jpg')}}"/>
                            </a>
                            <div class="des">
                                <a href="course_detail"><h2>scrapy教程</h2></a>
                        ...
                        <div class="module1_5 box">
                            <a href="course_detail">
                                <img width="214" height="190" src="{{asset('index/media/courses/2016/12/mysql.jpg')}}"/>
                            </a>
                            <div class="des">
                            ...
                            <div class="bottom">
                                ...
                                <span class="delete-group fr jsDeleteFav_course" data-favid="13"></span>
                            </div>
                        </div>
