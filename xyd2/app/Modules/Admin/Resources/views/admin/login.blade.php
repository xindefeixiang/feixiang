...
<head>
    ...
    <link href="{{asset('admin/css/login.css') }}" rel="stylesheet" rev="stylesheet" type="text/css" media="all" />
    <script type="text/javascript" src="{{asset('admin/js/jQuery1.7.js') }}"></script>
    <script type="text/javascript" src="{{asset('admin/jquery-1.8.2.min.js') }}"></script>
    <script type="text/javascript" src="{{asset('admin/js/jquery1.42.min.js') }}"></script>
    <script type="text/javascript" src="{{asset('admin/js/jquery.SuperSlide.js') }}"></script>
        ...
        <div>
            ...
            <form action="admin/login" method="post" class="stu_login_error">
                ...
                <div id="code">
                    ...
                    <img src="{{captcha_src()}}" onclick="this.src='{{captcha_src()}}'+Math.random()" title="点击更换" alt="验证码占位图">
                    {{--<img src="{{asset('admin/images//captcha.jpg') }}" title="点击更换" alt="验证码占位图"/>--}} </div>
                <div id="remember">
...
<div class="screenbg">
    <ul>
        <li><a href="javascript:;"><img src="{{asset('admin/images//0.jpg') }}"></a></li>
        <li><a href="javascript:;"><img src="{{asset('admin/images//1.jpg') }}"></a></li>
        <li><a href="javascript:;"><img src="{{asset('admin/images//2.jpg') }}"></a></li>
    </ul>
</div>
</body>
</html>
