...
<section>
    <div class="wp">
        <ul class="feature">
            <li class="feature1">
                <img class="pic" src="{{asset('index/images/feature1.png') }}"/>
                <p class="center">专业权威</p>
            </li>
            <li class="feature2">
                <img class="pic" src="{{asset('index/images/feature2.png') }}"/>
                <p class="center">课程最新</p>
            </li>
            <li class="feature3">
                <img class="pic" src="{{asset('index/images/feature3.png') }}"/>
                <p class="center">名师授课</p>
            </li>
            <li class="feature4">
                <img class="pic" src="{{asset('index/images/feature4.png') }}"/>
        ...
        <div class="wp">
            ...
            <div class="module1 eachmod">
                <div class="module1_1 left">
                    <img width="228" height="614" src="{{asset('index/images/module1_1.jpg') }}"/>
        ...
        <div class="wp">
            ...
            <div class="module3 eachmod">
                <div class="module3_1 left">
                    <img width="228" height="463" src="{{asset('index/images/module3_1.jpg') }}"/>
...
<script type="text/javascript" src="{{asset('index/js/index.js') }}"></script>
