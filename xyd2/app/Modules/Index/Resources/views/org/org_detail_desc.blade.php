    ...
    <div class="wp list personal_list comp">
        <div class="left">
            <ul>
                ...
                <li class="active2"><a href="org_detail_desc">机构介绍</a></li>
