...
<section>
    <div class="wp list personal_list comp">
        <div class="left">
            <ul>
                <li class="active2"><a href="org_detail_homepage">机构首页</a></li>
                <li class=""><a href="org_detail_course">机构课程</a></li>
        ...
        <div class="right companycenter layout grouping" >
            <div class="head">
                <h1>全部课程</h1>
                <a class="green fr more" href="org-detail_course">查看更多  >  </a>
            </div>
            <div class="brief group_list">

                <div class="module1_5 box">
                    <a href="course_detail"><img width="214" src="{{asset('index/media/courses/2016/11/mysql.jpg')}}"/></a>
                    <div class="des">
                ...
                <div class="module1_5 box">
                    <a href="course_detail"><img width="214" src="{{asset('index/media/courses/2016/11/540e57300001d6d906000338-240-135_mvvGYHL.jpg')}}"/></a>
                    <div class="des">
                ...
                <div class="module1_5 box">
                    <a href="course_detail"><img width="214" src="{{asset('index/media/courses/2016/12/python错误和异常.jpg')}}"/></a>
                    <div class="des">
        ...
        <div class="right companycenter layout" >
            <div class="head">
                <h1>机构教师</h1>
                <a class="green fr more" href="org_detail_teachers">查看更多  >  </a>
            </div>

            <div class="diarys">
                <div class="module5 share company-diary-box" style="padding:10px 0;">
                    <div class="left">
                        <img class="pic" src="{{asset('index/media/teacher/2016/11/aobama_CXWwMef.png')}}"/>
                        <p>昵称：bobby</p>
                    </div>
                    <div class="right">
                        <div class="top">
