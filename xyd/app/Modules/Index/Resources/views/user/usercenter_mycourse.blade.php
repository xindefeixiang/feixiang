...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{{asset('index/css/lq.datetimepick.css')}}"/>
...
<section class="headerwrap headerwrap2">
    <header>
        <div  class="header2 header">
            ...
            <div class="middle">
                <div class="wp">
                    <a href="index"><img class="fl" src="{{asset('index/images/logo2.png')}}"/></a>
                    <h1>我的慕学网</h1>
                </div>
            </div>
        </div>
...
<section>
    <div class="wp list personal_list">
        <div class="left">
            <ul>
                <li class="active2"><a href="usercenter_info">个人资料</a></li>
                <li ><a href="usercenter_mycourse">我的课程</a></li>
                <li ><a href="usercenter_fav_course">我的收藏</a></li>
                <li >
            ...
            <div class="personal_des permessage">
                <div class="companycenter">
                    <div class="group_list brief">
                        ...
                        <div class="module1_5 box">
                            <a href="course_detail">
                                <img width="214" height="190" class="scrollLoading" src="{{asset('index/media/courses/2016/12/python文件处理.jpg')}}"/>
                            </a>
                            <div class="des">
                                <a href="course_detail"><h2>python文件处理</h2></a>
                                <span class="fl">课时：<i class="key">0</i></span>
                        ...
                        <div class="module1_5 box">
                            <a href="course_detail">
                                <img width="214" height="190" class="scrollLoading" src="{{asset('index')}}/media/courses/2016/11/57035ff200014b8a06000338-240-135_dHfj8Nq.jpg"/>
                            </a>
                            <div class="des">
                                <a href="course_detail"><h2>java入门2</h2></a>
                                <span class="fl">课时：<i class="key">0</i></span>
                                <span class="fr">学习人数：0</span>
                            </div>
                            <div class="bottom">
                                <span class="fl">慕课网2</span>
                                <span class="star fr  notlogin" data-favid="15">0</span>
                            </div>
                        </div>
                        ...
                        <div class="module1_5 box">
                            <a href="course_detail">
                                <img width="214" height="190" class="scrollLoading" src="{{asset('index/media/courses/2016/11/mysql.jpg')}}"/>
                            </a>
                            <div class="des">
                        ...
                        <div class="module1_5 box">
                            <a href="course_detail">
                                <img width="214" height="190" class="scrollLoading" src="{{asset('index/media/courses/2016/11/57035ff200014b8a06000338-240-135_0nFiBSI.jpg')}}"/>
                            </a>
                            <div class="des">
                                <a href="course_detail"><h2>java入门3</h2></a>
                                <span class="fl">课时：<i class="key">0</i></span>
                                <span class="fr">学习人数：1</span>
                            </div>
                            <div class="bottom">
                                <span class="fl">慕课网3</span>
                                <span class="star fr  notlogin" data-favid="15">0</span>
                            </div>
                        </div>
                        ...
                        <div class="module1_5 box">
                            <a href="course_detail">
                                <img width="214" height="190" class="scrollLoading" src="{{asset('index/media/courses/2016/12/python面向对象.jpg')}}"/>
                            </a>
                            <div class="des">
                                <a href="course_detail"><h2>python面向对象</h2></a>
                                <span class="fl">课时：<i class="key">0</i></span>
                                <span class="fr">学习人数：1</span>
                            </div>
                            <div class="bottom">
...
<div class="dialog" id="jsDialog">
    ...
    <div  class="noactivebox dialogbox" id="jsUnactiveForm" >
        ...
        <div class="close jsCloseDialog"><img src="{{asset('index/images/dig_close.png')}}"/></div>
        <div class="center">
            <img src="{{asset('index/images/send.png')}}"/>
...
<script src="{{asset('inde/js/validateDialog.jsx')}}"  type="text/javascript"></script>
<script src="{{asset('index/js/deco-common.js')}}"  type="text/javascript"></script>

<script src='{{asset('index/js/plugins/jquery.upload.js')}}' type='text/javascript'></script>
<script src="{{asset('index/js/validate.js')}}" type="text/javascript"></script>
<script src="{{asset('index/js/deco-user.js')}}"></script>
