...
<div class="mainBox" style="height:auto!important;height:550px;min-height:550px;">
    <h3><a href="arganshow" class="actionBtn">机构列表</a>修改机构</h3>
    <form action="arganupdate" method="post" enctype="multipart/form-data">
        <table width="100%" border="0" cellpadding="8" cellspacing="0" class="tableBasic">
            ...
            <tr>
                ...
                <td>
                    <input type="text" name="address" value="{{$data['address']}}" size="50" class="inpMain" />
                </td>
            </tr>
            <tr>
                <td align="right">机构域名</td>
                <td>
                    <input type="text" name="url" value="{{$data['url']}}" size="50" class="inpMain" />
                </td>
            </tr>
            <tr>
                ...
                <td>
                    ...
                    <img src="../../{{$data['logo']}}" width="100px" height="100px"></td>
            </tr>
            <tr>
                <td align="right" valign="top">机构描述</td>
                <td>
                    <textarea id="content" name="desc" style="width:780px;height:400px;" class="textArea">{{$data['desc']}}</textarea>
                </td>
            </tr>
            <tr>
                <td></td>
