...
<div class="mainBox" style="height:auto!important;height:550px;min-height:550px;">
    <h3><a href="teachershow" class="actionBtn">讲师列表</a>修改讲师信息</h3>
    <form action="teacherupdate" method="post" enctype="multipart/form-data">
        <table width="100%" border="0" cellpadding="8" cellspacing="0" class="tableBasic">
            ...
            <tr>
                ...
                <td>
                    <input type="text" name="age" value="{{$data['age']}}" size="50" class="inpMain" />
                </td>
            </tr>
            <tr>
                <td align="right">工作经验</td>
                <td>
                    <input type="text" name="year" value="{{$data['year']}}" size="50" class="inpMain" />
                </td>
            </tr>
            <tr>
                <td align="right">讲师职位</td>
                <td>
                    <input type="text" name="post" value="{{$data['post']}}" size="50" class="inpMain" />
                </td>
            </tr>
            <tr>
                <td align="right">公司</td>
                <td>
                    <input type="text" name="company" value="{{$data['company']}}" size="50" class="inpMain" />
                </td>
            </tr>
            <tr>
                <td align="right" valign="top">讲课特点</td>
                <td>
                    <textarea id="content" name="trait" style="width:780px;height:400px;" class="textArea">{{$data['trait']}}</textarea>
                </td>
            </tr>
            <tr>
                <td></td>
